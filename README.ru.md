...
- хранить данные локально в JSON
...
Пока данные хранятся локально:
 • задачи — в storage/tasks.json
 • события — в storage/calendar.json

В репозиторий эти файлы не пушатся.
...
Следующие возможные шаги:
 • улучшение качества русской озвучки и fallback на Piper
 • улучшение fallback-логики для неоднозначных фраз даты и времени
