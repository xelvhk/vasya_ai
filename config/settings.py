...
APP_VERSION = os.getenv("APP_VERSION", "0.5.50")
...
API_RATE_LIMIT_CHAT_MAX = int(os.getenv("API_RATE_LIMIT_CHAT_MAX", "30"))
API_RATE_LIMIT_PIPELINE_MAX = int(os.getenv("API_RATE_LIMIT_PIPELINE_MAX", "20"))
