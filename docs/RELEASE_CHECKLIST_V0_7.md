...
- Optionally put release `.env` in the unpacked directory, next to
  `Vasya AI.app` and `Vasya AI Doctor`; if it is missing, first run creates one
  with a generated `VASYA_API_AUTH_TOKEN`.
- Launch `Vasya AI.app`.
